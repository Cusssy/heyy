...
if (command === 'help') {
    ...
    outputDiv.innerHTML += 'Lista de mis proyectos<br><br> -    <a href="https://github.com/Cusssy/tweet-cutter">Tweet cutter</a><br><br>Cree esta pagina web usando ChatGPT para poder ver todo el potencia que puede dar esta IA, puedo asegurar que no habre editado mas de 20 lineas de codigo en total, 99% lo ha hecho la IA, asique nada mas este proyecto se va a quedar aqui pero no creo que le haga muchos cambios en un futuro<br><br> Web: <a href="https://cutter.cusssy.com">Tweet Cutter</a><br><br> -    <a href="https://github.com/Cusssy/WordFinder">WordFinder</a><br><br>Un sencillo programa que usa la whisper la inteligencia artificia de OpenAI para transcribir todos tus videos/audios a texto el cual sera almacenado en una base de datos de mongoDB.<br><br> -    WordFinder_Twitch <br> <br>Mismo funcionamiento a WordFinder pero para Twitch, descarga todos los clips de un canal, los procesa y los sube a la base de datos de mongoDB.<br><br>Web: <a href="https://wordfinder.cusssy.com">WordFinder</a> <br><br> ...<br><br> <a href="https://github.com/Cusssy?tab=repositories">Otros repositorios.</a><br><br>';
